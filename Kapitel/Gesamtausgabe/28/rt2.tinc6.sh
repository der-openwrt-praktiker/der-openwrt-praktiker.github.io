...
uci set tinc.RT2.Address=2001:db8:3::2
...
uci add_list tinc.RT3.Address=2001:db8:3::3
...
#!/bin/sh
ip -6 addr add fd00:2::2/128 dev \$INTERFACE
...
ip -6 addr del fd00:2::2/128 dev \$INTERFACE
EOF
