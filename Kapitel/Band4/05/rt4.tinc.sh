...
uci set tinc.RT4.Address=203.0.113.4
uci set tinc.RT4.Subnet=10.4.1.0/24
...
uci add_list firewall.@rule[-1].dest_ip='203.0.113.4'
uci commit
...
#!/bin/sh
ip addr add 10.4.1.4/32 dev \$INTERFACE
...
ip addr del 10.4.1.4/32 dev \$INTERFACE
EOF
